...
### Translation model for {src}-{trg} HPLT v1.0
...
* Cleaning: We use OpusCleaner for cleaning the corpus. Details about rules used can be found in the filter files in [Github](https://github.com/hplt-project/HPLT-MT-Models/tree/main/v1.0/data/{langpair}/raw/v0) 
